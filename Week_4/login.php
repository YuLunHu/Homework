...
<form id="form1" name="form1" method="post" action="login.php">
  <table width="300" border="0" align="center" cellpadding="5" cellspacing="0" bgcolor="#518edf">
    <tr>
    ...
    <tr>
      <td colspan="2" align="center" bgcolor="#CCCCCC">
        <input class="button button1" type="submit" name="btnOK" id="btnOK" value="登入" />
        <input class="button button1" type="reset" name="btnReset" id="btnReset" value="重設" />
        <input class="button button1" type="submit" name="btnHome" id="btnHome" value="回首頁" />
      </td>
    </tr>
  </table>
</form>
